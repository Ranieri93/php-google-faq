<?php
    $faq = [
        [
            ...
            "seconda" => [
                ...
                'risposta' => "Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire  un'elevatasicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.
 ...
 <html lang="en" dir="ltr">
     ...
     <body>
         <header>
            <div id="header-top" class="d-flex a-it-cent">
                <a href="#"> <img class="img-responsive" src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_74x24dp.png" alt=""></a> <span>Privacy e termini</span>
            </div>
            <div class="nav-bottom d-flex j-cont-sp-between">
                <div id="left-side-nav">
                    <ul class="d-flex f-dir-row">
         ...
         <main id="faq-section" class="d-flex j-cont-cent">
            <div class="container">
                <?php
                foreach ($faq as $key => $value) {?>
                    <div class="wrapper-faq">
                        <h1><?php echo $value["prima"]["domanda"] ?></h1>
                        <p><?php echo $value["prima"]["risposta"] ?></p>
                        <br>
                    </div>
                    <div class="wrapper-faq">
                        <h1><?php echo $value["seconda"]["domanda"] ?></h1>
                        <p><?php echo $value["seconda"]["risposta"] ?></p>
                        <br>
                    </div>
                    <div class="wrapper-faq">
                        <h1><?php echo $value["terza"]["domanda"] ?></h1>
                        <p><?php echo $value["terza"]["risposta"] ?></p>
                        <br>
                    </div>
                    <div class="wrapper-faq">
                        <h1><?php echo $value["quarta"]["domanda"] ?></h1>
                        <p><?php echo $value["quarta"]["risposta"] ?></p>
                        <br>
                    </div>
                <?php };  ?>
            </div>
